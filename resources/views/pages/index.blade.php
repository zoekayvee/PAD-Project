...
@section('content')
    <div class="container">
        ...
        <h2>Look at the adress bar. Is it http://localhost:8000/?
            ...
            <h2>please check "public" folder sa project directory natin. Dun nakalagay lahat ng resources like images,
                css, javascript
                <br>Furthermore, please check <b>resources/views/pages</b>
                explore <b>index.blade.php</b> (code ng page na ito) at <b>profile.blade.php</b> (code ng profile page,
                (c) Beili)
                **** Yung <b>template.blade.php</b> sa <b>resources/views</b> yung pinaka mother page nila. check the
                format.
            </h2>
            <br>
        </h2>
